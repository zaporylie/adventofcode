...
class DayTenExtraCommand extends Command
{
    protected static $defaultName = 'app:day:ten:extra';
    ...
    protected function configure()
    {
        $this
            ...
            ->setDescription('Runs tenth extra task.');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $answer = $this->service->executeExtra($input->getArgument('input')); // @todo: Provide input.
        $io->success($answer);
    }
}
